        ...
        for (Genome genome : genomes) {
            ...
            for (Chromosome chr : genome.getChromosomes()) {
                ...
                for (Gene gene : chr.getGenes()) {
                    out.write(gene.getAlgorithmId() + SEPERATOR + gene.getExternalId() + SEPERATOR + gene.getTag() + SEPERATOR + gene.getAnnotation() + SEPERATOR + gene.getName() + SEPERATOR + gene.getFamilySize());
                    out.newLine();
                }
